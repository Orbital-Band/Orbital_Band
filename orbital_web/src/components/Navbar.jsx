...
const Navbar = ({ currentPage, setCurrentPage, cart = [] }) => {
        ...
        <div className="dropdown dropdown-end">
          ...
          <div
            ...
            <div className="card-body">
              <span className="text-lg font-bold">{totalItems} {totalItems === 1 ? 'Artículo' : 'Artículos'}</span>
              <span className="text-info">Subtotal: ${subtotal}</span>
              <div className="card-actions">
                <button className="btn btn-primary btn-block" onClick={() => setCurrentPage('checkout')}>Checkout</button>
              </div>
            </div>
          </div>
        </div>
